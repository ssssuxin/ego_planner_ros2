...
typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::Image, geometry_msgs::TransformStamped> approx_policy;
...
void image_pose_callback(
    const sensor_msgs::msg::Image::SharedPtr image_input,
...
int main(int argc, char **argv)
{
  ...
  // pub_posedimage = nh.advertise<sensor_msgs::msg::Image>("posedimage",1000);
